...
a new connection. You can build a TCP or a serial connection.

:jmbusPackage: org/openmuc/jmbus

:wiredSerialSample: {sampleSrc}/{jmbusPackage}/sample/WiredSerialMBusConnection.java
:wiredTcpSample: {sampleSrc}/{jmbusPackage}/sample/WiredTcpMBusConnection.java

[source,java]
.Opening a new M-Bus serial connection.
----
include::{wiredSerialSample}[tags=todoc,indent=0]
----

[source,java]
.Opening a new M-Bus TCP connection.
----
include::{wiredTcpSample}[tags=todoc,indent=0]
----
...
.Read from Device.
----
include::{wiredSerialSample}[tags=readtodoc,indent=0]
----
...
.Write to Device.
----
include::{wiredSerialSample}[tags=writetodoc,indent=0]
----
